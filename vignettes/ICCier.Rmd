...
To relax the homogeneity assumption, the mixed effects location scale model (MELSM) can be used [@Rast2012a; @Hedeker2008; @Hedeker2012; @Li2012].
...
$$
\text{uICC(1)}_{ij} = \frac{\hat\sigma^2_{u_0,i}}{\hat\sigma^2_{u_0,i} + \hat\sigma^2_{\epsilon,ij}} = \frac{\exp(\boldsymbol{X_i\eta_{\cdot 1}})^2}{\exp(\boldsymbol{X_i\eta_{\cdot 1}})^2 + \exp(\boldsymbol{z_{ij}\gamma_i})^2}
$$
